...
function CheckOutPage () {
    return(
        <div className="bg-gray-200 lg:w-1/2 md:w-3/4 md:m-auto md:mt-10 md:mb-10 m-4 rounded sm:px-18 px-5 py-5 ">
             ...
             <form action="">
                 ...
                 <OrderSummary />
              <button className="bg-orange-600 text-gray-200 w-1/2 md:w-1/3 p-1 rounded hover:bg-gray-800 cursor-pointer">Place order</button>
             </form>
        </div>
    )
}
